...
const About = (props, { data }) => (
  <Layout location={props.location}>
    ...
    <h4>Welding</h4>
    <p>
      I want to restore and work on cars eventually. I feel this is a necessary
      skill for that.
    </p>
    ...
    <h4>New Zealand</h4>
    <p>
      Much like Iceland New Zealand has an amazing range of breathtaking scenery
      but from subtropical forests to snow-covered mountains.
    </p>

    <h4>Pikes Peak International Hill Climb</h4>
    <p>
      The Pikes Peak International Hill Climb, also known as The Race to the
      Clouds, is an annual automobile and motorcycle hillclimb to the summit of
